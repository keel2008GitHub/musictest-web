(function (t) {
    function e(e) {
        for (var n, o, r = e[0], c = e[1], l = e[2], p = 0, d = []; p < r.length; p++) o = r[p], Object.prototype.hasOwnProperty.call(s, o) && s[o] && d.push(s[o][0]), s[o] = 0;
    ...
    0: function (t, e, i) {
            ...
            props: {
                ...
                initCanvas: function () {
                    ...
                    this.leftTitle.map((function (e, i) {
                        ...
                        t.ctx.fillStyle = "#333333", t.ctx.fillText(.25 * (i + 1), t.spanX * e + t.spanX / 2, t.height - 4), t.ctx.textAlign = "center"
                    }))
        ...
        }), l = c, u = (i("be50"), i("2877")), p = Object(u["a"])(l, o, r, !1, null, "e82cea40", null), d = p.exports;
                ...
                s = i.createScriptProcessor || i.createJavaScriptNode, a = s.apply(i, [4096, 1, 1]), o = {
                    ...
                    encodeWAV: function () {
                        ...
                        if (c("RIFF"), r += 4, a.setUint32(r, 36 + n, !0), r += 4, c("WAVE"), r += 4, c("fmt "), r += 4, a.setUint32(r, 16, !0), r += 4, a.setUint16(r, 1, !0), r += 2, a.setUint16(r, o, !0), r += 2, a.setUint32(r, t, !0), r += 4, a.setUint32(r, o * t * (e / 8), !0), r += 4, a.setUint16(r, o * (e / 8), !0), r += 2, a.setUint16(r, e, !0), r += 2, c("data"), r += 4, a.setUint32(r, n, !0), r += 4, 8 === e) for (var l = 0; l < i.length; l++, r++) {
                            var u = Math.max(-1, Math.min(1, i[l])), p = u < 0 ? 32768 * u : 32767 * u;
                            p = parseInt(255 / (65535 / (p + 32768))), a.setInt8(r, p, !0)
        ...
        h.throwError = function (t) {
            throw alert(t), new function () {
                this.toString = function () {
                    return t
                }
            }
        }, h.canRecording = null != navigator.getUserMedia, h.get = function (t, e) {
            if (t) {
                if (!navigator.getUserMedia) return void h.throwErr("当前浏览器不支持录音功能。");
                navigator.getUserMedia({audio: !0}, (function (i) {
                    ...
                    switch (t.code || t.name) {
                        ...
                        case"PermissionDeniedError":
                            h.throwError("用户拒绝提供信息。");
                            break;
                        case"NOT_SUPPORTED_ERROR":
                        case"NotSupportedError":
                            h.throwError("浏览器不支持硬件设备。");
                            break;
                        case"MANDATORY_UNSATISFIED_ERROR":
                        case"MandatoryUnsatisfiedError":
                            h.throwError("无法发现指定的硬件设备。");
                            break;
                        default:
                            h.throwError("无法打开麦克风。异常信息:" + (t.code || t.name));
                            break
                    }
                }))
            }
        };
        var f = h, y = i("bc3a"), v = i.n(y), m = {baseURL: ""};
        v.a.defaults.baseURL = m.baseURL, v.a.defaults.headers.post["Content-Type"] = "application/json";
        var x = v.a.create();
        ...
        var g = x, T = {humming: "/humming", mix: "/mix"}, L = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return g.post(T.humming, t)
        }, b = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return g.post(T.mix, t)
        }, w = (i("a4d3"), i("e01a"), i("d28b"), i("99af"), i("c975"), i("ac1f"), i("1276"), {
            positionListToYinList: function (t, e) {
                var i = [], n = !0, s = !1, a = void 0;
                try {
                    for (var o, r = t[Symbol.iterator](); !(n = (o = r.next()).done); n = !0) {
                        var c = o.value, l = c.x, u = c.y, p = "".concat(e[u], "|").concat(l + 1);
                        i.push(p)
                    }
                } catch (d) {
                    s = !0, a = d
                ...
                try {
                    for (var o, r = t[Symbol.iterator](); !(n = (o = r.next()).done); n = !0) {
                        var c = o.value, l = c.split("|"), u = e.indexOf(l[0]), p = parseInt(l[1]) - 1,
                            d = {x: p, y: u};
                        i.push(d)
                    }
                } catch (h) {
            ...
            name: "app", components: {MusicalNote: d}, data: function () {
                return {
                    ...
                    openType: !0,
                    baseURL: m.baseURL,
                    audio_url: m.baseURL + "/static/finalversion.wav",
                    dotList: [],
                ...
                closeIcoClick: function () {
                    ...
                    console.log(3333), e.timeType = 0, setTimeout((function () {
                        console.log("timeType", e.timeType), 0 == e.timeType ? e.moveAnType = !0 : e.moveAnType = !1
                    }), 4e3), t.play(), e.playStatus = "doing", t.addEventListener("ended", (function () {
                    ...
                    i.append("audioData", this.recorder.getBlob()), L(i).then((function (i) {
                        e.params = i, t.dotList = w.yinListToPosition(i.notes, t.lineData), t.dispalyList = w.yinListToDisplayList(i.notes, t.lineData), t.maskType = !1, t.audioType = !0, t.openType = !0
                    }))
                }, mixHas: function () {
                    var t = this;
                    this.maskType = !0, this.audioType = !1, console.log(this.params), b(this.params).then((function (e) {
                        t.playType = !0, t.dotList = w.yinListToPosition(e.notes, t.lineData), t.dispalyList = w.yinListToDisplayList(e.notes, t.lineData), t.maskType = !1, t.audioType = !0, t.audio_url = t.baseURL + "/static/finalversion.wav?t=" + (new Date).getTime()
                    }))
                }, getAllPosition: function (t) {
                    this.playType = !1;
                    var e = document.querySelector("#my_audio");
                    e.pause(), this.playStatus = e.paused, this.moveAnType = !1, this.playStatus = "over", this.params.notes = w.positionListToYinList(t, this.lineData), this.dispalyList = w.yinListToDisplayList(this.params.notes, this.lineData)
                }
            }, mounted: function () {
                console.log(1111111111)
            }
        }, C = S, k = (i("034f"), Object(u["a"])(C, s, a, !1, null, null, null)), D = k.exports;
        ...
        "use strict";
        var n = i("3990"), s = i.n(n);
        s.a
    }
});
//# sourceMappingURL=app.2a319f95.js.map