(function (t) {
    function e(e) {
        for (var n, o, r = e[0], c = e[1], l = e[2], d = 0, p = []; d < r.length; d++) o = r[d], Object.prototype.hasOwnProperty.call(s, o) && s[o] && p.push(s[o][0]), s[o] = 0;
    ...
    0: function (t, e, i) {
        ...
        }), l = c, u = (i("d3af"), i("2877")), d = Object(u["a"])(l, o, r, !1, null, "4847edca", null), p = d.exports;
                ...
                s = i.createScriptProcessor || i.createJavaScriptNode, a = s.apply(i, [4096, 1, 1]), o = {
                    ...
                    encodeWAV: function () {
                        ...
                        if (c("RIFF"), r += 4, a.setUint32(r, 36 + n, !0), r += 4, c("WAVE"), r += 4, c("fmt "), r += 4, a.setUint32(r, 16, !0), r += 4, a.setUint16(r, 1, !0), r += 2, a.setUint16(r, o, !0), r += 2, a.setUint32(r, t, !0), r += 4, a.setUint32(r, o * t * (e / 8), !0), r += 4, a.setUint16(r, o * (e / 8), !0), r += 2, a.setUint16(r, e, !0), r += 2, c("data"), r += 4, a.setUint32(r, n, !0), r += 4, 8 === e) for (var l = 0; l < i.length; l++, r++) {
                            var u = Math.max(-1, Math.min(1, i[l])), d = u < 0 ? 32768 * u : 32767 * u;
                            d = parseInt(255 / (65535 / (d + 32768))), a.setInt8(r, d, !0)
        ...
        var g = x, L = {humming: "/humming", mix: "/mix"}, w = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return g.post(L.humming, t)
        }, b = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return g.post(L.mix, t)
        }, T = (i("a4d3"), i("e01a"), i("d28b"), i("99af"), i("c975"), i("ac1f"), i("1276"), {
            positionListToYinList: function (t, e) {
                var i = [], n = !0, s = !1, a = void 0;
                try {
                    for (var o, r = t[Symbol.iterator](); !(n = (o = r.next()).done); n = !0) {
                        var c = o.value, l = c.x, u = c.y, d = "".concat(e[u], "|").concat(l + 1);
                        i.push(d)
                    }
                } catch (p) {
                    s = !0, a = p
                ...
                try {
                    for (var o, r = t[Symbol.iterator](); !(n = (o = r.next()).done); n = !0) {
                        var c = o.value, l = c.split("|"), u = e.indexOf(l[0]), d = parseInt(l[1]) - 1,
                            p = {x: d, y: u};
                        i.push(p)
                    }
                } catch (h) {
            ...
            name: "app", components: {MusicalNote: p}, data: function () {
                return {
                    playType: !1,
                    audioType: !0,
                    aboutType: !1,
                ...
                closeIcoClick: function () {
                    ...
                    t.pause(), this.playStatus = t.paused, this.playStatus = "over"
                    ...
                    i.append("audioData", this.recorder.getBlob()), w(i).then((function (i) {
                        e.params = i, t.dotList = T.yinListToPosition(i.notes, t.lineData), t.dispalyList = T.yinListToDisplayList(i.notes, t.lineData), t.maskType = !1, t.audioType = !0, t.openType = !0
                    }))
                }, mixHas: function () {
                    var t = this;
                    this.maskType = !0, this.audioType = !1, console.log(this.params), b(this.params).then((function (e) {
                        t.playType = !0, t.dotList = T.yinListToPosition(e.notes, t.lineData), t.dispalyList = T.yinListToDisplayList(e.notes, t.lineData), t.maskType = !1, t.audioType = !0, t.audio_url = t.baseURL + "/static/finalversion.wav?t=" + (new Date).getTime()
                    }))
                }, getAllPosition: function (t) {
                    this.playType = !1;
                    var e = document.querySelector("#my_audio");
                    e.pause(), this.playStatus = e.paused, this.playStatus = "over", this.params.notes = T.positionListToYinList(t, this.lineData), this.dispalyList = T.yinListToDisplayList(this.params.notes, this.lineData)
                }
            }, mounted: function () {
        ...
        "use strict";
        var n = i("e498"), s = i.n(n);
        s.a
    }, e498: function (t, e, i) {
    }
});
//# sourceMappingURL=app.85b87bd0.js.map